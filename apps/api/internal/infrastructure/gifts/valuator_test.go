...
func TestStakingQuoteSkipsHaircut(t *testing.T) {
	price, source := finalizeQuote(2_520_000_000, PriceSourceTraits, false)
	if price != 2_520_000_000 {
		t.Fatalf("staking quote should not apply haircut, got %d", price)
	}
