...
func migrateCases(db *gorm.DB) error {
	...
	seeds := []caseSeed{
		{
			...
			AccentColor: "#3b82f6", PriceNanoton: ton(2.5),
		...
		},
		{
			...
			AccentColor: "#22c55e", PriceNanoton: 0,
		...
		},
		{
			...
			AccentColor: "#16a34a", PriceNanoton: ton(0.5), Kind: domain.CaseKindCatalog, SortOrder: 10,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#ea580c", PriceNanoton: ton(1.2), Kind: domain.CaseKindCatalog, SortOrder: 20,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#9333ea", PriceNanoton: ton(1.8), Kind: domain.CaseKindCatalog, SortOrder: 30,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#475569", PriceNanoton: ton(2.0), Kind: domain.CaseKindCatalog, SortOrder: 40,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#ca8a04", PriceNanoton: ton(3.0), Kind: domain.CaseKindCatalog, SortOrder: 50,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#2563eb", PriceNanoton: ton(5.0), Kind: domain.CaseKindCatalog, SortOrder: 60,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#dc2626", PriceNanoton: ton(7.5), Kind: domain.CaseKindCatalog, SortOrder: 70,
			Loot: []lootSeed{
		...
		},
		{
			...
			AccentColor: "#7c3aed", PriceNanoton: ton(10.0), Kind: domain.CaseKindCatalog, SortOrder: 80,
			Loot: []lootSeed{
	...
	for _, cs := range seeds {
		...
		if err := db.Table(domain.Case{}.TableName()).Clauses(clause.OnConflict{
			...
			DoUpdates: clause.AssignmentColumns([]string{"title", "accent_color", "price_nanoton", "kind", "sort_order", "active", "target_rtp_bps"}),
