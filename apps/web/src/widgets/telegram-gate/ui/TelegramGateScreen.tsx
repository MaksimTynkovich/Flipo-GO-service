...
export function TelegramGateScreen() {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center bg-background px-6 py-10 text-center">
      <div className="mb-6 flex size-20 items-center justify-center rounded-[1.75rem] bg-accent/15 text-accent shadow-[0_20px_60px_rgba(135,116,225,0.18)]">
      ...
      <a
        ...
        className="app-control mt-8 inline-flex h-11 min-w-[220px] items-center justify-center rounded-xl bg-accent px-4 text-sm font-semibold text-white active:bg-accent/90"
      >
        Открыть в Telegram
      </a>
