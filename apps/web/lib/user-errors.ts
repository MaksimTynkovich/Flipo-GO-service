...
export function formatUserError(
  ...
  const rules: Array<[RegExp | string, string]> = [
    ...
    ["вывод из стейка доступен только в конце дня", "Вывод из стейка — после 00:05 МСК"],
    ["вывод из стейка доступен только в конце недели", "Вывод из стейка — после 00:05 МСК"],
    ["unstaking is not available", "Вывод из стейка — после 00:05 МСК"],
