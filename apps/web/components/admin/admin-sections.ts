...
import QuestStatsSection from "./sections/QuestStatsSection";
...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { id: "quest-stats", href: "/admin/quest-stats", label: "Статистика заданий" },
